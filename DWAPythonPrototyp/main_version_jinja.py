...
def sta_90er_view_PLAN_B(schema_name, p_src_table, p_ts):    
...
def sta_91er_view_PLAN_B(schema_name, p_src_table, p_ts):
...
def sta_table_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
...
def dwh_table_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
{%- set ns = namespace(has_pk=0) -%}
if exists (select 1 
...
def rep_views_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
if exists (select 1 
...
def proc_sta_dummy_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
if exists (select 1 
...
def proc_sta_full_load_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
if exists (select 1 
...
def proc_sta_delete_detection_PLAN_B(schema_name, p_src_table, p_ts):
    tmplSQL = """
